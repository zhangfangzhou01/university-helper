...
import com.yhm.universityhelper.entity.po.Quartz;
import org.quartz.*;
...
public class QuartzUtils {
     ...
     * @throws Exception
     */
    public static void createScheduleJob(Scheduler scheduler, Quartz quartzBean) {
        try {
     ...
     * @throws SchedulerException
     */
    public static void updateScheduleJob(Scheduler scheduler, Quartz quartzBean) {
        try {
            //获取到对应任务的触发器
